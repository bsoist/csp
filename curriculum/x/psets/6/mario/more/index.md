...
* Write, in a file called `mario.py` in `~/pset6/mario/more/`, a program that recreates these half-pyramids using hashes (`#`) for blocks, exactly [as you did in C](../../1/mario/more/), except that your program this time should be written (a) in Python and (b) in CS50 IDE.
